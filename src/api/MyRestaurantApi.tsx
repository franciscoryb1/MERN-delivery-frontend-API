...
export const useUpdateMyRestaurantOrder = () => {
    ...
    const uopdateMyRestaurantOrder = async (updateStatusOrderRequest: UpdateOrderSatusRequest) => {
        const accessToken = await getAccessTokenSilently();

        console.log('updateFunciton', updateStatusOrderRequest);
    ...
    const { mutateAsync: updateRestaurantStatus, isLoading, isError, isSuccess, reset } = useMutation(uopdateMyRestaurantOrder);
